            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
				  <?php $unit_permission = DB::table('permissions')->where('name', 'unit')->first();
				 ...
				 <?php if($unit_permission_active): ?>
                  ...
                  <?php endif; ?>
				  <?php $brand_permission = DB::table('permissions')->where('name', 'brand')->first();
...
</html><?php /**PATH C:\xampp\htdocs\elitebotique\resources\views/layout/main.blade.php ENDPATH**/ ?>