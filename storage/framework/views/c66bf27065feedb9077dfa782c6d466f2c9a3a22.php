            ...
            <div class="row">
				<div class="col-md-2 mt-3">
                    <div class="form-group">
                      <label class="d-tc mt-2"><strong>Choose Category</strong> &nbsp;</label><br>
                        <div class="d-tc">
                           ...
                           <select id="category_id" name="category_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                               <option value=""><?php echo e(trans('All Category')); ?></option>
                ...
                <tr>
                    ...
                    <?php
                            ...
                            if($variant_id[$key]) {
								...
								$discount = DB::table('sales')
                                    ->join('product_sales', 'sales.id', '=', 'product_sales.sale_id')->where([
                                        ...
                                        ['variant_id', $variant_id[$key] ],
                                    ])->whereDate('sales.created_at','>=', $start_date)->whereDate('sales.created_at','<=', $end_date)->sum('order_discount');
                        ...
                        if($purchased_qty > 0)
                           ...
                           $profit =  $sold_price;
                    ?>
                    <td><?php echo e(number_format((float)$purchased_cost, 3, '.', '')); ?></td>
                    <td><?php echo e($purchased_qty); ?></td>
                    <td><?php echo e(number_format((float)$sold_price-$discount, 3, '.', '')); ?></td>
                    <td><?php echo e($sold_qty); ?></td>
                    <td><?php echo e(number_format((float)$profit, 3, '.', '')); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\elitebotique\resources\views/report/product_report.blade.php ENDPATH**/ ?>